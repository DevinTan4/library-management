...
const LoginPage = () => {
  return (
    <div className="flex text-white font-inter">
      ...
      {/* Right side */}
      <div className="w-1/2 bg-[#003161] pt-[79px] px-[63px] pb-[66px]">
        {/* Header */}
        ...
        <form action="">
          ...
          <div>
            ...
            <input
              ...
              className="placeholder:text-white bg-transparent outline-none ml-[16.06px] opacity-50 placeholder:font-light leading-[21.78px] placeholder:text-lg w"
            />
          </div>
          ...
          <div className="flex align-middle">
            ...
            <input
              ...
              size="49"
              className="placeholder:text-white bg-transparent outline-none ml-[16.06px] opacity-50 placeholder:font-light leading-[21.78px] placeholder:text-lg mr-1"
            />
            <span className="">
          ...
          {/* Forgot your password, remmeber me, and login button */}
